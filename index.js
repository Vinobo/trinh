...
mongoose.connect('mongodb+srv://1234:1234@cluster0.76l4h.mongodb.net/ATNShop?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true}, function(err){
    if (err){
...
app.get("/productp", controllerUser.productp);
